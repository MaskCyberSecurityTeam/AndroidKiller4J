package com.richardtang.androidkiller4j.ui.border;
...
public class MLineBorder extends LineBorder {
    ...
    // 想起项目UI风格中边框的默认颜色
    public static Color defaultBorderColor = UIManager.getColor("Component.borderColor");
